...
const LeistungenOnlinePrasenzPage = () => {
  return (
    <>
      <Helmet>
        <title>Online Präsenz & SEO - Castle Media</title>
        <meta name="description" content="Wir sorgen dafür, dass dich deine Kunden online finden. SEO und Social Media Management von Castle Media." />
      </Helmet>
...
export default LeistungenOnlinePrasenzPage;
