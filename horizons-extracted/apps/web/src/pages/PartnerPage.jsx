...
const PartnerPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Unsere Partner - Castle Media</title>
        <meta name="description" content="Entdecke unsere Partner und erfahre mehr über erfolgreiche Zusammenarbeit mit Castle Media." />
      </Helmet>
